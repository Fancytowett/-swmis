                        ...
                        <table class="table table-hover table-striped" id="datatable">
                            ...
                            @foreach($residents as $resident)
                                <tr>
                                    ...
                                    <td>
                                        <a  class="btn btn-info btn-xs"  data-target="#view{{$resident->id}}" data-toggle="modal">View</a>
                                        <div class="modal fade" id="view{{$resident->id}}" style="margin-top: 50px;margin-left: 450px;margin-right: 400px;;">
