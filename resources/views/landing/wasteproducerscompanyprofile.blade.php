                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" v-model="company.phone" class="form-control"  maxlength="10"   name="phone" id="phone" placeholder="Enter phone">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" v-model="company.period" name="period">
